...
public class ParserTest {
	...
	public void testParseAll() {
		...
		Client expected1 = new Client(new UserAgent("Firefox", "3", "5", "5"),
				new OS("Mac OS X", "10", "4", null, null), new Device("Other"));
		Client expected2 = new Client(new UserAgent("Mobile Safari", "5", "1", null),
				new OS("iOS", "5", "1", "1", null), new Device("iPhone"));
	...
	void testUserAgentFromYaml(String filename) {
		...
		List<Map<String, String>> testCases = (List<Map<String, String>>) ((Map<String, List<Map<String, String>>>) yaml.load(yamlStream)).get("test_cases");
