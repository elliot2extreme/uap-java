...
public class CachingParser extends Parser {
	...
	public Client parse(String agentString) {
		...
		if (cacheClient == null) {
			cacheClient = new LRUMap<String, Client>(CACHE_SIZE);
		}
	...
	public UserAgent parseUserAgent(String agentString) {
		...
		if (cacheUserAgent == null) {
			cacheUserAgent = new LRUMap<String, UserAgent>(CACHE_SIZE);
		}
	...
	public Device parseDevice(String agentString) {
		...
		if (cacheDevice == null) {
			cacheDevice = new LRUMap<String, Device>(CACHE_SIZE);
		}
	...
	public OS parseOS(String agentString) {
		...
		if (cacheOS == null) {
			cacheOS = new LRUMap<String, OS>(CACHE_SIZE);
		}
